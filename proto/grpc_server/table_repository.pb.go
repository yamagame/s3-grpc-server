...
func (x *ListTableRequest) Reset() {
	*x = ListTableRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_grpc_server_table_repository_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ListTableRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTableRequest) ProtoMessage() {}

func (x *ListTableRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_grpc_server_table_repository_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTableRequest.ProtoReflect.Descriptor instead.
func (*ListTableRequest) Descriptor() ([]byte, []int) {
	return file_proto_grpc_server_table_repository_proto_rawDescGZIP(), []int{8}
}
...
func (x *ListTableResponse) Reset() {
	*x = ListTableResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_grpc_server_table_repository_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ListTableResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTableResponse) ProtoMessage() {}

func (x *ListTableResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_grpc_server_table_repository_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTableResponse.ProtoReflect.Descriptor instead.
func (*ListTableResponse) Descriptor() ([]byte, []int) {
	return file_proto_grpc_server_table_repository_proto_rawDescGZIP(), []int{9}
}

func (x *ListTableResponse) GetTables() []*Table {
	if x != nil {
		return x.Tables
	}
	return nil
...
var file_proto_grpc_server_table_repository_proto_rawDesc = []byte{
	...
	,
	...
	0x12, 0x11, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x06, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c,
	...
	0x12, 0x35, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x14, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12,
	0x11, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x12, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65,
...
var file_proto_grpc_server_table_repository_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_grpc_server_table_repository_proto_goTypes = []interface{}{
	...
	(*ListTableRequest)(nil),    // 8: ListTableRequest
	(*ListTableResponse)(nil),   // 9: ListTableResponse
	(*Table)(nil),               // 10: Table
}
var file_proto_grpc_server_table_repository_proto_depIdxs = []int32{
	10, // 0: CreateTableRequest.table:type_name -> Table
	10, // 1: ReadTableResponse.table:type_name -> Table
	10, // 2: UpdateTableRequest.table:type_name -> Table
	10, // 3: ListTableResponse.tables:type_name -> Table
	0,  // 4: TableRepository.Create:input_type -> CreateTableRequest
	2,  // 5: TableRepository.Read:input_type -> ReadTableRequest
	4,  // 6: TableRepository.Update:input_type -> UpdateTableRequest
	6,  // 7: TableRepository.Delete:input_type -> DeleteTableRequest
	8,  // 8: TableRepository.List:input_type -> ListTableRequest
	1,  // 9: TableRepository.Create:output_type -> CreateTableResponse
	3,  // 10: TableRepository.Read:output_type -> ReadTableResponse
	5,  // 11: TableRepository.Update:output_type -> UpdateTableResponse
	7,  // 12: TableRepository.Delete:output_type -> DeleteTableResponse
	9,  // 13: TableRepository.List:output_type -> ListTableResponse
...
func file_proto_grpc_server_table_repository_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_grpc_server_table_repository_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListTableRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_grpc_server_table_repository_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListTableResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
